...
cd "$installPath"
sudo -u brewpi git clone https://github.com/ryancargill/brewpi-script "$installPath"||die
cd "$webPath"
sudo -u www-data git clone https://github.com/ryancargill/brewpi-www "$webPath"||die
